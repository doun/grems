...
//
	...
	function Button_Onclick()
	{
		...
		if (JHshTextEmpty(formInput.liqut_altitude,"表压(bar)")) return ;
		if (!JHshIsNumber(formInput.liqut_altitude,"表压(bar)")) return ;
		if (!JCheckTxtISDateTime(formInput.cycle_time,"充气结束时间")) return;
		if (!JCheckTxtISDateTime(formInput.apply_date,"签发时间")) return;
		if (JHshSelectEmpty(formInput.apply_userid,"签发人")) return ;
		
		
		if (JHshTextEmpty(formInput.pubnum1,"滤膜")) return ;
		if (!JHshIsNumber(formInput.pubnum1,"滤膜")) return ;
		...
		if (JHshTextEmpty(formInput.scale_b,"总β")) return ;
		if (JHshTextEmpty(formInput.scale_y,"气体总γ")) return ;
		...
		if (JHshTextEmpty(formInput.scale_co58,"CO58")) return ;
		if (JHshTextEmpty(formInput.scale_co60,"CO60")) return ;
		if (JHshTextEmpty(formInput.scale_cs134,"CS134")) return ;
		if (JHshTextEmpty(formInput.scale_cs137,"CS137")) return ;
		...
		if (JHshTextEmpty(formInput.Release_Bucket_Pressure,"开始排放时表压")) return ;
		if (!JHshIsNumber(formInput.Release_Bucket_Pressure,"开始排放时表压")) return ;
		if (JHshTextEmpty(formInput.Release_bucket_pressure2,"结束排放时表压")) return ;
		if (!JHshIsNumber(formInput.Release_bucket_pressure2,"结束排放时表压")) return ;
		...
		if(formInput.lb_special_release.checked)
		{
			...
			formInput.action = "InputSave.asp?Op=Add&Sys=TEG&Special=True";
			formInput.submit() ;
		}
		else
		{
			formInput.target="ifrSave";
			formInput.action = "InputSave.asp?Op=Add&Sys=TEG";
			formInput.submit() ;
		}
	}
	...
	function Station_onchange()
	{
		...
		if( formInput.station.value == "D")
		{
			...
			ops.add(new Option("",""));
			ops.add(new Option("D9TEG002BA","D9TEG002BA"));
			ops.add(new Option("D9TEG003BA","D9TEG003BA"));
			ops.add(new Option("D9TEG004BA","D9TEG004BA"));
			ops.add(new Option("D9TEG005BA","D9TEG005BA"));
			ops.add(new Option("D9TEG006BA","D9TEG006BA"));
			ops.add(new Option("D9TEG007BA","D9TEG007BA"));
		...
		else
		{
			...
			formInput.Bucket_No.innerHTML = "";			
			ops.add(new Option("",""));
			ops.add(new Option("L9TEG004BA","L9TEG004BA"));
			ops.add(new Option("L9TEG005BA","L9TEG005BA"));
			ops.add(new Option("L9TEG006BA","L9TEG006BA"));
			ops.add(new Option("L9TEG007BA","L9TEG007BA"));
			ops.add(new Option("L9TEG008BA","L9TEG008BA"));
			ops.add(new Option("L9TEG009BA","L9TEG009BA"));
			ops.add(new Option("L9TEG010BA","L9TEG010BA"));
			ops.add(new Option("L9TEG011BA","L9TEG011BA"));
			...
			<table style="font-size: 14px; width: 100%; height: 1; border-collapse: collapse" id="table3">
				...
				<tr>
					...
					<input type=checkbox id="lb_special_release" name="lb_special_release"><font color=red>特殊排放</font>
						...
						<Input ID=Sys_Type name=Sys_Type Value=TEG></td>
				...
				<tr>
					...
					<table class="noborder" id="table5">
						...
						<tr>
							...
							<option value='D9TEG002BA'>D9TEG002BA</option>
							<option value='D9TEG003BA'>D9TEG003BA</option>
							<option value='D9TEG004BA'>D9TEG004BA</option>
							<option value='D9TEG005BA'>D9TEG005BA</option>
							<option value='D9TEG006BA'>D9TEG006BA</option>
							<option value='D9TEG007BA'>D9TEG007BA</option>
							...
							<td>：</td>
							<td id="相对压力(Bar)"><nobr><Input ID='liqut_altitude' name='liqut_altitude'></nobr></td>
						</tr>
						<tr>
							<td class="label"><nobr>充气结束时间</nobr>
							</td>
							<td>：</td>
							<td id="充气结束时间"><nobr><Input name='cycle_time' onmousedown="dateTime.calendar(this)" ></nobr></td>
						</tr>
						<tr>
							<td class="label"><nobr>签发时间</nobr>
							</td>
							<td>：</td>
							<td id="签发时间"><nobr><Input name='apply_date' onmousedown="dateTime.calendar(this)" ></nobr></td>
				...
				<tr>
					...
					<table class="noborder" id="table6">
						...
						<tr>
							...
							<td>：</td>
							<td id="滤膜(m&lt;sup&gt;3&lt;/sup&gt;)"><nobr><Input name='pubnum1'></nobr></td>
			...
			　<Input name='sample_special_reason' size=80></div>
				...
				<tr>
					...
					<table id="table7" style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid; HEIGHT: 1px">
						...
						<tr>
							<td class="label" align="middle">总β(Bq/m<sup>3</sup>)
							</td>
							<td class="label" align="middle">气体总γ(Bq/m<sup>3</sup>)
							</td>
...
　<table style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid; HEIGHT: 1px" id="table8">
						...
						<tr>
							<td id="co58" align="middle"><input name='scale_co58'></td>
							<td id="co60" align="middle"><input name='scale_co60'></td>
							<td id="cs134" align="middle"><input name='scale_cs134'></td>
							<td id="cs137" align="middle"><input name='scale_cs137'></td>
						</tr>
						<tr>
					...
					<table class="noborder" id="table9">
						...
						<tr>
							...
							<td><Input name='scale_scale_date' onmousedown="dateTime.calendar(this)" ></td>
						</tr>
					</table>
		<br>
		<fieldset style="BORDER-RIGHT: 0px; BORDER-TOP: black 1px solid; BORDER-LEFT: 0px; WIDTH: 100%; BORDER-BOTTOM: black 1px solid">
		...
		<div style="font-size: 13px; text-align: left; scrollbar-face-color: GREEN; scrollbar-arrow-color: white; scrollbar-highlight-color: white; scrollbar-3dlight-color: green; scrollbar-shadow-color: white; scrollbar-darkshadow-color: darkgreen; scrollbar-track-color: #eef">
			　<Input name='scale_special_reason' size=80></div>
				...
				<tr>
					<td class="labelT" id='lb_shenpi'>运行处</td>
