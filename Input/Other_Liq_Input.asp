...
//
	...
	function Button_Onclick()
	{
		...
		if (JHshSelectEmpty(formInput.Bucket_No,"系统号")) return ;
		...
		if (JHshTextEmpty(formInput.pubnum1,"系统号")) return ;		
		...
		if (JHshTextEmpty(formInput.release_bucket_pressure,"排放前液位")) return ;
		if (!JHshIsNumber(formInput.release_bucket_pressure,"排放前液位")) return ;
		
		if (JHshTextEmpty(formInput.release_bucket_pressure2,"排放后液位")) return ;
		if (!JHshIsNumber(formInput.release_bucket_pressure2,"排放后液位")) return ;
		...
		if(formInput.lb_special_release.checked)
		{
			...
			formInput.action = "InputSave.asp?Op=Add&Sys=LIQ&Special=True";
			formInput.submit() ;
		}
		else
		{
			formInput.target="ifrSave";
			formInput.action = "InputSave.asp?Op=Add&Sys=LIQ";
			formInput.submit() ;
		}
	}
			...
			<table style="font-size: 14px; width: 100%; height: 1; border-collapse: collapse" id="table3">
				...
				<tr>
					...
					<input type=checkbox id="lb_special_release" name="lb_special_release"><font color=red>特殊排放</font>
						...
						<Input ID=Sys_Type name=Sys_Type Value=LIQ></td>
				...
				<tr>
					...
					<table class="noborder" id="table5">
						...
						<tr>
							...
							<td id="系统号" style="border: 0 none"><nobr><Input ID='Bucket_No' name='Bucket_No' onchange='return Bucket_Change()'></nobr></td>
						...
						<tr>
							...
							<td style="border: 0 none">：</td>
							<td id="签发时间" style="border: 0 none"><nobr>
							<Input name='apply_date' onmousedown="dateTime.calendar(this)" ></nobr></td>
				...
				<tr>
					...
					<table class="noborder" id="table6">
						...
						<tr>
							...
							<td style="border: 0 none">：</td>
							<td id="系统号" style="border: 0 none"><nobr><Input name='pubnum1'></nobr></td>
							
							<td class="label"><nobr>液位(m)</nobr>
							</td>
							<td style="border: 0 none">：</td>
							<td id="液位(m)" style="border: 0 none"><nobr><Input ID='pubnum2' name='pubnum2'></nobr></td>
						...
						<tr>
							...
							<td style="border: 0 none">：</td>
							<td id="取样时间" style="border: 0 none"><nobr>
							<Input name='sample_date' onmousedown="dateTime.calendar(this)"></nobr></td>
						</tr>
...
　<table style="page-break-inside: avoid; font-size: 14px; width: 100%; height: 1; border-collapse: collapse; border: 0px none" id="table12">
						...
						<table style="page-break-inside: avoid; font-size: 14px; width: 100%; height: 1; border-collapse: collapse; border: 0px none" id="table1">
	<tr>
		<td style="height: 5px; text-align: center; border: 0px none">　</td>
	</tr>
	<tr>
		<td style="height: 1px; text-align: center; border: 0px none">
		<table style="font-size: 14px; width: 100%; height: 1; border-collapse: collapse" id="table2">
			<colgroup>
			...
			<tr>
				...
				<td id="bucket_pressure" align="middle" style="text-align: center; border: 1px solid black">
			...
			<tr>
				...
				<td id="bucket_pressure2" align="middle" style="text-align: center; border: 1px solid black">
