...
//
	...
	function Button_Onclick()
	{
		...
		if(formInput.lb_special_release.checked)
		{
			...
			formInput.action = "InputSave.asp?Op=Add&Sys=SEL&Special=True";
			formInput.submit() ;
		}
		else
		{
			formInput.target="ifrSave";
			formInput.action = "InputSave.asp?Op=Add&Sys=SEL";
			formInput.submit() ;
		}
	}
	...
	function Station_onchange()
	{
		...
		if( formInput.station.value == "D")
		{
			...
			ops.add(new Option("",""));
			ops.add(new Option("D0SEL001BA","D0SEL001BA"));
			ops.add(new Option("D0SEL002BA","D0SEL002BA"));
			ops.add(new Option("D0SEL003BA","D0SEL003BA"));
			formInput.lb_9KRT904MA.value = "9KRT904MA可用";
			formInput.lb_9KRT904MA.style.backgroundColor ="linen";
		...
		else
		{
			...
			formInput.Bucket_No.innerHTML = "";
			ops.add(new Option("",""));
			ops.add(new Option("L0SEL001BA","L0SEL001BA"));
			ops.add(new Option("L0SEL002BA","L0SEL002BA"));
			ops.add(new Option("L0SEL003BA","L0SEL003BA"));
			formInput.lb_9KRT904MA.value = "9KRT902MA可用";	
			formInput.lb_9KRT904MA.style.backgroundColor ="lightblue";
			...
			<table style="font-size: 14px; width: 100%; height: 1; border-collapse: collapse" id="table3">
				...
				<tr>
					...
					<input type=checkbox id="lb_special_release" name="lb_special_release"><font color=red>特殊排放</font>
						...
						<Input ID=Sys_Type name=Sys_Type Value=SEL></td>
	...
	<td class="labelT">运行处</td>
		...
		<table class="noborder" id="table3">
			...
			<tr>
				...
				<Option value=''></Option>
				<Option value='D0SEL001BA'>D0SEL001BA</Option>
				<Option value='D0SEL002BA'>D0SEL002BA</Option>
				<Option value='D0SEL003BA'>D0SEL003BA</Option>
				</select></nobr></td>
...
　<table style="font-size: 14px; width: 100%; height: 1; border-collapse: collapse; border: 1px solid black" id="table8">
						...
						<tr style="HEIGHT: 1px">
							...
							当总γ≥80000 Bq/m<sup>3</sup>时，γ能谱测量结果(单位：Bq/m<sup>3</sup>)</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<table style="font-size: 14px; width: 100%; height: 1; border-collapse: collapse" id="table13">
								<tr>
									...
									<input id='lb_9KRT904MA' name='lb_9KRT904MA' readonly style='BORDER:0px solid #3c3;color:black;' value='9KRT904MA可用'>
									</nobr> 
									</td>
