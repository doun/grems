...
function checkall() {
         ...
         if (document.form1.impower.value =="") 
         {
                alert("请填写用户补充");
                document.form1.impower.focus();
                return false; 
         }
...
<form action="user_add0.asp" method="post"  name="form1" onsubmit="return checkall()">
  ...
  <table width="99%" border="1" align="center" cellpadding="5" cellspacing="0" bordercolorlight="#A5C8F1" bordercolordark="#ffffff" bgcolor=#ddf0ff>
	  <tr><td >
		  ...
		  <td colspan=6 >
			...
			<tr>
			<td>
			&nbsp;<font color=blue>修改用户补充<font face=webdings>6</font></font>
			</td>
			<td align=right>
		  ...
		  <td  align=right>用户补充：</td><td colspan=5>&nbsp;<br><textarea name=impower cols=70 rows=14 class="rec_form"><%=userArray1(10,0)%></textarea><br></td>
		  </tr>
		  <tr><td align=center colspan=6 height=40><input type="submit" name="Submit" value=" 修　改 用 户 补 充 " class="rec_form"> <input type="reset" name="Submit2" value=" 重 置 " class="rec_form"> <input type="button" name="button" value=" 返 回 " class="rec_form" onclick="window.history.go(-1)">
		  </td></form></tr>
			</table>
		  </td>
		  </tr>		  
