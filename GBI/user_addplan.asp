...
<form action="user_addplan0.asp" method="post"  name="form1" onsubmit="return checkall()">
  ...
  <table width="99%" border="1" align="center" cellpadding="5" cellspacing="0" bordercolorlight="#A5C8F1" bordercolordark="#ffffff" bgcolor=#ddf0ff>
	  <tr><td >
		  ...
		  <td colspan=6 >
			...
			<tr>
			<td>
			&nbsp;<font color=blue>修改项目进度<font face=webdings>6</font></font>
			</td>
			<td align=right>
		  ...
		  <td  align=right>项目进展：</td><td colspan=5 align=center>
			  <table width="95%" border="0" align="center" cellpadding="2" cellspacing="0" bordercolorlight="#A5C8F1" bordercolordark="#ffffff">
				<tr><td height=10></td></tr>
			 </table>
			 <%if userArray1(9,0)<>"" and not isnull(userArray1(9,0)) then%>
		   	  <table width="95%" border="1" align="center" cellpadding="2" cellspacing="0" bordercolorlight="#A5C8F1" bordercolordark="#ffffff" bgcolor=#ffffff>
			 ...
			 <%end if%>
			<textarea name=plan cols=71 rows=10 class="rec_form"></textarea>
			<table width="95%" border="0" align="center" cellpadding="2" cellspacing="0" bordercolorlight="#A5C8F1" bordercolordark="#ffffff">
				<tr><td height=10></td></tr>
			 </table>
			</td>
		  </tr>
		  <tr><td align=center colspan=6 height=40><input type="submit" name="Submit" value=" 修　改 项 目 进 展 " class="rec_form"> <input type="reset" name="Submit2" value=" 重 置 " class="rec_form"> <input type="button" name="button" value=" 返 回 " class="rec_form" onclick="window.history.go(-1)">
		  </td></form></tr>
			</table>
		  </td>
		  </tr>		  
