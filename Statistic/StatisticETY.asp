...
function schange(){
		document.sform.action="StatisticETY.asp";
...
call dbQuery(ETYSQL_Count,ETYCountSQL_Count,ssArray_Count,ssRows_Count)
	...
	p "<tr bgcolor=#339933>"
	p "<td height=30>&nbsp;<font color=yellow>矩形图表</font>&nbsp;<a href='StatisticShapeEach.asp?"&LinkStr&"'><font color=yellow>次数</font></a>&nbsp;<a href='StatisticShapeEach.asp?"&LinkStrT&"'><font color=yellow>时间</font></a>&nbsp;<a href='StatisticETY_E.asp?content="&mdate&"' onclick='return openWin(this.href)'><font color=yellow>输出Excel</font></a>&nbsp;&nbsp;<a href='StatisticETYp.asp?content="&mdate&"' onclick='return openWin(this.href)'><font color=yellow>我要打印</font></a></td>"
