...
OptionTabs.prototype.InitContainer=function(e)
{
	...
	eval(sTmp)
	var sShadowStyle='<v:shadow on="t"/>'
...
{
	this.NormalDefault(e,'backgroundColor', '#4a4');
	this.NormalDefault(e,'color',   '#ffd700');
	this.CustomDefault(e,'TabOrientation', 'top');
	this.CustomDefault(e,'shadowcolor', 'black');
	this.CustomDefault(e,'lightcolor', '#ffd700');
	this.CustomDefault(e,'backfillcolor', '#4A9304');
	this.CustomDefault(e,'backcolor', 'yellowgreen');
