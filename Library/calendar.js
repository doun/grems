 ...
 var strIframe = "<html><head><meta http-equiv='Content-Type' content='text/html; charset=gb2312'><style>"+
    ...
    "    </nobr></td><td align=center><input name=today type=button value='Today' onfocus='this.blur()' style='width: 100%;border-right:1px solid white' title='当前日期&#13;快捷键：T'"+
...
function WebCalendar() //初始化日历的设置
{
    ...
    this.darkColor  = "yellowgreen";    //控件的暗色
    this.lightColor = "#FFFFFF";    //控件的亮色
    this.btnBgColor = "yellowgreen";    //控件的按钮背景色
    this.wordColor  = "green";    //控件的文字颜色
    this.wordDark   = "orange";    //控件的暗文字颜色
    this.dayBgColor = "#F5F5FA";    //日期数字背景色
    this.todayColor = "yellowgreen";    //今天在日历上的标示背景色
...
function calendar() //主调函数
{
    ...
    window.oDHTMLCelendar.show(0,-198,144,199,WebCalendar.objExport)
